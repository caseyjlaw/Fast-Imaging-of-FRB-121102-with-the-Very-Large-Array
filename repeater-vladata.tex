...
Four of the VLA bursts were observed simultaneously with Arecibo and AMI-LA, while two were observed simultaneously with all four observatories (Figure \ref{fig:multi}). Of these bursts, only the VLA burst on MJD 57648 was simultaneously detected by another observatory, Arecibo. The VLA and Arecibo burst detections had significances of 25$\sigma$\ and xx$\sigma$, respectively. 

Figure \ref{fig:sgram} shows a dynamic spectrum for the 57648 burst with the VLA and AO bursts resampled to the same grid. The temporal resolution of the VLA data (5~ms) is much coarser than that of Arecibo and barycentric corrections, so we only need to correct for DM to align the bursts in time.
