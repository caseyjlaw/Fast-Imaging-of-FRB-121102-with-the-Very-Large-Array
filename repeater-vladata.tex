...
%More data is needed to determine if bursts trace intrinsic processes, such as coherent, pulsar-like emission \citep{2014PhRvD..89j3009K, 2014ApJ...785L..26L, 2016MNRAS.457..232C} or if extrinsic effects also play a role \citep{2015MNRAS.451.3278M, CORDES}. 
...
Computational (Jupyter) notebooks to reproduce the transient detection, localization, and analysis presented here can be found at \software{\url{https://github.com/caseyjlaw/FRB121102}}. Time cut-out visibility data and calibration products are available at \url{https://doi.org/10.7910/DVN/TLDKXG}. Original VLA visibility data are available under NRAO program codes 16A-459 and 16A-496 and can be downloaded at \url{http://archive.nrao.edu}.
...
% ** expand on implication of spectral envelope in scintillation models **
...
% ** add mjd colum **
% ** use footnotes instead of last two cols? **
...
\small
\tablecaption{Table of Observations \label{tab:obs}}
%\centering
%\begin{tabular}{lcccccc}
\startdata
Day & Start time & Duration & Band & VLA Detections & Other Coverage & Other Detections \\
(yyyy-mm-dd; UT) & (hh:mm:ss; UT) & (minutes) & & & &  \\ \hline
2015-11-25 & 3:25:29 & 60 & 1.4~GHz & 0 &  & \\
...
\enddata
\tablecomments{Arecibo, Effelsberg, and AMI-LA observations were conducted at 1.4, 4.5, and 15~GHz, respectively.}
%\end{tabular}
%\tablenotetext{a}{}
%\label{tab:obs}
\end{deluxetable*} 
