...
{\color{red}Jason/Shami: ok if copied from the first paper?}
...
\caption{Probability distribution of powerlaw luminosity model for the nine VLA bursts from \frb. The powerlaw is referenced to $L=2\times10^{38}$\ erg.
\label{fig:lumd}}
\end{center}
\end{figure}
