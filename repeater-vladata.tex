...
**redo multispec figure and comparison of \alpha**

Figure \ref{fig:multi} shows spectra built from integrated flux densities measured (or limited) during three burst with multi-telescope observing coverage. The burst on 17 Sep 2016 was detected with VLA and Arecibo with significances of 25$\sigma$\ and 39$\sigma$, which corresponds to peak flux densities of in 5~ms of 111 mJy and 14 mJy at 3 and 1.4~GHz, respectively. Here we assume a typical pulse width of 2~ms and measure VLA and Arecibo integrated flux densities of **xx and yy mJy** at 3 and 1.4~GHz, respectively.
