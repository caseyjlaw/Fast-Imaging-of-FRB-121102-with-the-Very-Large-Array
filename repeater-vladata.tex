...
% ** quantify how much of model shape is actually inside the band **

% ** confusion as to whether inter-channel modulation is signal or noise ** jim also to do noise analysis **
% ** could quantify deviations from Gaussian model relative to noise. An SNR relative to envelope.

% ** spectra plot modifications: **
% y-axis scale not shown! 
% add mjd to each plot
% Need to make sure impression differs of noise and inter-channel modulation
...
% ** fix plot to show "W" instead of "dint"
