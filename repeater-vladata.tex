...
\caption{Summary of observing coverage during the multi-telescope observing campaign. Uncircled symbols show days with observations and circles show detections of \frb. Only the coincident Arecibo burst is currently circled (**change?**). The black dashed line shows the VLA burst detections with simultaneous coverage with other telescopes.
\label{fig:multi}}
\end{center}
\end{figure*}
