...
Effelsberg & 4.85 & 100  & 0.8   & 0.0655 & 0.032 & 0.056 \\
...
\citet{2017arXiv170102370M} use the young magnetar model for FRBs to calculate the maximum number of bursts that can be powered by its magnetic field as $\approx3000 (0.1/\Omega_b)$. This rate comparison suggests that the SLSN-I rate is most consistent with the FRB rate, although there is significant room for adjustment in the models and rate estimate. Under that model, \frb\ could emit bursts for roughly 400 days at the peak burst rate measured by the VLA. Continued monitoring of \frb\ bursts will continue to be useful in testing models for FRB origin.
