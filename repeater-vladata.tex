...
Bursts seem to drop throughout last campaign. The nominal rate is 1e-4 per second, but a someone higher rate is inferred from modeling shown in Figure \ref{fig:rate}.
